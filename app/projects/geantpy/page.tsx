      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 pt-16 flex flex-col gap-16">
        ...
        <section className="grid grid-cols-1 md:grid-cols-12 gap-6 items-start border-t border-white/[0.04] pt-8">
          ...
          <div className="md:col-span-8 flex flex-col gap-4 text-neutral-300 text-[15px] font-light leading-relaxed">
            <p>
              GeantPy is a Python orchestration layer built around the Geant4 simulation toolkit. Rather than replacing Geant4's simulation engine, it automates experiment configuration, execution, parameter exploration, and result collection through a unified Python interface.
            </p>
            <p>
              Designed for reproducible computational physics workflows, GeantPy enables researchers to build scalable simulation pipelines while preserving the flexibility and performance of the underlying Geant4 framework.
            </p>
          </div>
        </section>
        ...
        <section className="grid grid-cols-1 md:grid-cols-12 gap-6 items-start border-t border-white/[0.04] pt-8">
          ...
          <div className="md:col-span-8 flex flex-col gap-4 text-neutral-300 text-[15px] font-light leading-relaxed">
            <p>
              Large simulation studies in Geant4 often require repetitive C++ configuration, manual execution, and fragmented data processing.
            </p>
            <p>
              GeantPy streamlines these workflows through a Python-first orchestration layer, enabling reproducible experiment configuration, automated parameter sweeps, and structured analysis without modifying the underlying Geant4 simulation engine.
            </p>
          </div>
        </section>
        ...
        <section className="grid grid-cols-1 md:grid-cols-12 gap-6 items-start border-t border-white/[0.04] pt-8">
          ...
          <div className="md:col-span-8 flex flex-col gap-6">
            <div className="flex justify-center py-6 border border-white/[0.03] bg-neutral-950/20 rounded-md">
              <svg className="w-full max-w-[200px] h-auto" viewBox="0 0 160 220">
                {/* Box 1 */}
                <rect x="10" y="10" width="140" height="30" rx="4" fill="none" stroke="#ffffff" strokeWidth="1" />
                <text x="80" y="29" fill="#ffffff" fontSize="10" fontFamily="monospace" textAnchor="middle">Experiment Configuration</text>
                
                {/* Arrow 1 */}
                <path d="M 80,40 L 80,65" stroke="rgba(255, 255, 255, 0.4)" strokeWidth="1.5" markerEnd="url(#arrow)" />
                
                {/* Box 2 */}
                <rect x="10" y="70" width="140" height="30" rx="4" fill="none" stroke="#ffffff" strokeWidth="1" />
                <text x="80" y="89" fill="#ffffff" fontSize="10" fontFamily="monospace" textAnchor="middle">Simulation Execution</text>
                
                {/* Arrow 2 */}
                <path d="M 80,100 L 80,125" stroke="rgba(255, 255, 255, 0.4)" strokeWidth="1.5" markerEnd="url(#arrow)" />
                
                {/* Box 3 */}
                <rect x="10" y="130" width="140" height="30" rx="4" fill="none" stroke="#ffffff" strokeWidth="1" />
                <text x="80" y="149" fill="#ffffff" fontSize="10" fontFamily="monospace" textAnchor="middle">Data Extraction</text>
                
                {/* Arrow 3 */}
                <path d="M 80,160 L 80,185" stroke="rgba(255, 255, 255, 0.4)" strokeWidth="1.5" markerEnd="url(#arrow)" />
                
                {/* Box 4 */}
                <rect x="10" y="190" width="140" height="30" rx="4" fill="none" stroke="#ffffff" strokeWidth="1" />
                <text x="80" y="209" fill="#ffffff" fontSize="10" fontFamily="monospace" textAnchor="middle">Analysis</text>
        ...
        <section className="grid grid-cols-1 md:grid-cols-12 gap-6 items-start border-t border-white/[0.04] pt-8">
          ...
          <div className="md:col-span-8 grid grid-cols-1 sm:grid-cols-2 gap-4 font-mono text-[13px]">
            <div className="p-4 border border-white/[0.03] bg-neutral-950/20 rounded">
              <span className="text-white font-medium block mb-1">Experiment Configuration</span>
            ...
            <div className="p-4 border border-white/[0.03] bg-neutral-950/20 rounded">
              <span className="text-white font-medium block mb-1">Reproducible Execution</span>
            ...
            <div className="p-4 border border-white/[0.03] bg-neutral-950/20 rounded">
              <span className="text-white font-medium block mb-1">Parameter Exploration</span>
            ...
            <div className="p-4 border border-white/[0.03] bg-neutral-950/20 rounded">
              <span className="text-white font-medium block mb-1">Structured Data Pipeline</span>
        ...
        <section className="grid grid-cols-1 md:grid-cols-12 gap-6 items-start border-t border-white/[0.04] pt-8">
          ...
          <div className="md:col-span-8 flex flex-col gap-6">
            ...
            <p className="text-neutral-450 text-[13px] font-light leading-relaxed">
              GeantPy serves as the orchestration layer powering Janus while remaining fully modular and independently usable for automated Geant4-based computational physics workflows.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-2xl mx-auto flex flex-col items-center gap-5">
            ...
            <div className="flex flex-col sm:flex-row gap-3 mt-2">
              <Link
                ...
                target="_blank"
                className="inline-flex items-center justify-center px-6 py-2.5 bg-white text-black font-mono font-medium text-[13px] rounded hover:bg-neutral-200 transition-colors uppercase tracking-wider min-w-[160px]"
              >
